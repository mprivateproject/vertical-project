...
export default function LineLoginButton() {
  ...
  return (
    <>
      <button
        onClick={handleLogin}
        className="flex items-center justify-center gap-3 w-full p-4 rounded-2xl bg-[#06C755] text-white font-semibold shadow-lg shadow-[#06C755]/20 active:scale-[0.98] transition-transform"
      >
