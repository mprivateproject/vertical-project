    ...
    <div className="min-h-screen pb-36" style={{ background: bg }}>
      ...
      <div className="relative z-10 px-5 pt-14 space-y-6">
        ...
        >
          ...
          >
            {lang === 'th' ? 'รายการนัดหมาย' : 'Reservations'}
          </h1>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              <p
                ...
                style={{ color: isDark ? 'rgba(255,255,255,0.7)' : 'rgba(40,35,30,0.65)', fontFamily: 'var(--font-heading)' }}
              >
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-[24px] font-bold tabular-nums leading-tight"
                        style={{ color: titleColor, fontFamily: 'var(--font-body)' }}>
                        {dayStr}
                      </span>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        ...
                        style={{ color: serviceColor, fontFamily: 'var(--font-heading)', letterSpacing: '0.01em' }}
                      >
                    ...
                    {/* Chevron */}
                    <ChevronDown className="w-4 h-4 flex-shrink-0 -rotate-90" style={{ color: chevronColor }} />
                  </button>
